...
export const DOC_LAST_UPDATED = '9 de junio de 2026'
...
export const DOC_SECTIONS: DocSection[] = [
  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: 'paragraph',
        text: 'b1n0 es un mercado de contratos de evento donde demostrás que sabés más que todos. Hacés tu voto sobre eventos reales — fútbol, política, economía, cultura — y cobrás si tenés razón.',
      },
      {
        kind: 'paragraph',
  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: 'paragraph',
        text: 'Cada evento en b1n0 tiene dos lados: SÍ y NO. Cuando hacés tu voto, comprás "contratos" en uno de los lados. Cada contrato se liquida a un valor fijo de $1 bruto si tu lado gana — y $0 si pierde. Sobre ese cobro, b1n0 retiene una comisión de resolución del 5%, así que el cobro neto por contrato ganador es de $0.95.',
      },
      {
        kind: 'paragraph',
        text: 'El precio de cada contrato lo determina un AMM que refleja la oferta y la demanda del mercado en tiempo real. Si SÍ está a 62%, un contrato SÍ cuesta aproximadamente $0.62. Si NO está a 38%, un contrato NO cuesta $0.38. Cuanto más impopular tu lado, más barato el contrato — y más cobrás si tenés razón.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        ...
        body: 'María entra temprano: pone $50 en NO al precio $0.38. Su entrada compra ~131 contratos, que pagarán $131 brutos si NO gana (131 × $1), menos la comisión de resolución del 5% = $124.45 netos — 2.5× su entrada. Carlos entra tarde, al precio $0.65 cuando el consenso ya cambió: su $50 solo compra 77 contratos, que pagarán $77 brutos menos 5% = $73.15 netos si NO gana — 1.5× su entrada. Misma posición, distinto momento, distinto cobro. La ventaja viene del precio en el que entrás, no del pool creciendo después — tu cobro queda bloqueado al confirmar.',
      },
      {
        kind: 'paragraph',
      ...
      {
        kind: 'paragraph',
        text: 'Cuando el evento se resuelve, los ganadores cobran $1 × contratos en bruto, menos la comisión de resolución del 5% (cobro neto de $0.95 por contrato ganador), directamente en su saldo. Los perdedores no pagan nada extra — perdieron lo que pusieron, no más.',
      },
  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ['Comisión de compra', '1–5%', 'Cada vez que hacés un voto. La tasa exacta se muestra antes de confirmar.'],
          ['Spread (margen)', '1–2%', 'Capturado por el AMM en el precio que pagás al comprar.'],
          ['Comisión de venta anticipada', '2%', 'Si vendés tu posición antes de la resolución.'],
          ['Comisión de resolución', '5%', 'Sobre el cobro bruto del ganador (no sobre la ganancia).'],
        ],
        caption: 'Tasa total efectiva: ~8% combinado sobre el dinero que pasa por la plataforma. Idéntica a /terminos §7.',
      },
      {
        kind: 'callout',
        tone: 'positive',
  ...
  // ────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      {
        kind: 'paragraph',
        text: 'b1n0 opera como custodio regulado: tu saldo en moneda fiat se mantiene en cuentas segregadas con instituciones financieras reguladas en Centroamérica. Eso significa que tus fondos no se mezclan con el capital operativo de Tres33, y no podemos disponer de ellos para gastos de la empresa.',
      },
      {
        kind: 'paragraph',
        text: 'Al tomar una posición, adquirís un contrato de evento cuyo cobro se representa de forma tokenizada. La emisión y custodia de esa representación operan bajo el marco de activos digitales de la Comisión Nacional de Activos Digitales (CNAD) de El Salvador, a través de un proveedor licenciado. Los fondos que respaldan los pagos se mantienen en cuentas segregadas.',
      },
      {
        kind: 'bullets',
        items: [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'NO es bolsa de valores. No operamos con acciones ni bonos.',
      ...
      {
        kind: 'paragraph',
        text: 'b1n0 ofrece contratos de evento sobre activos digitales; cuando un evento se resuelve, quienes acertaron cobran el valor fijo del contrato menos las comisiones publicadas. La tokenización de los contratos opera bajo el marco de la CNAD de El Salvador a través de un proveedor licenciado. Tomar una posición implica riesgo de pérdida de capital y no constituye una recomendación de inversión.',
      },
    ],
  },
